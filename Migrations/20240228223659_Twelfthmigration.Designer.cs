...
namespace GoTravnikApi.Migrations
{
    ...
    [Migration("20240228223659_Twelfthmigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GoTravnikApi.Models.Rating", b =>
                {
                    ...
                    b.Property<int>("RatedTouristContentId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("RatedTouristContentId");
            ...
            modelBuilder.Entity("GoTravnikApi.Models.RatedTouristContent", b =>
                {
                    b.HasBaseType("GoTravnikApi.Models.TouristContent");

                    b.ToTable("RatedTouristContent");
                });

            modelBuilder.Entity("GoTravnikApi.Models.Accommodation", b =>
                {
                    b.HasBaseType("GoTravnikApi.Models.RatedTouristContent");
            ...
            modelBuilder.Entity("GoTravnikApi.Models.Image", b =>
                {
                    b.HasOne("GoTravnikApi.Models.TouristContent", "TouristContent")
                        .WithMany("Images")
                        .HasForeignKey("TouristContentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("TouristContent");
                });

            modelBuilder.Entity("GoTravnikApi.Models.Rating", b =>
                {
                    b.HasOne("GoTravnikApi.Models.RatedTouristContent", "RatedTouristContent")
                        .WithMany("Ratings")
                        .HasForeignKey("RatedTouristContentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("RatedTouristContent");
                });
            ...
            modelBuilder.Entity("GoTravnikApi.Models.RatedTouristContent", b =>
                {
                    b.HasOne("GoTravnikApi.Models.TouristContent", null)
                        .WithOne()
                        .HasForeignKey("GoTravnikApi.Models.RatedTouristContent", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("GoTravnikApi.Models.Accommodation", b =>
                {
                    b.HasOne("GoTravnikApi.Models.RatedTouristContent", null)
                        .WithOne()
